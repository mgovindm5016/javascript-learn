...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.enterCredentials = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.lppage.locator("#username").fill(username)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.lppage.locator("#password").fill(password)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    LoginPage.prototype.clickLogin = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.lppage.locator("#Login").click()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    LoginPage.prototype.verifyTitle = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.lppage.waitForTimeout(3000)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.lppage.title()];
                    case 2:
                        title = _a.sent();
                        console.log("The page title is : ".concat(title));
                        return [2 /*return*/];
                }
            });
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, login.loadurl("https://login.salesforce.com/?locale=in")];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, login.enterCredentials("dilipkumar.rajendran@testleaf.com", "TestLeaf@2025")];
                case 5:
                    _a.sent();
