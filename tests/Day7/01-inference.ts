let num=40; //here implictly we are telling the typescript that num is number type

let num1 : number =50; //here explictly we are telling the typescript that num1 is number type
